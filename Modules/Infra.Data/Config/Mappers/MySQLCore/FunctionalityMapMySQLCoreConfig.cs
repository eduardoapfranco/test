...
namespace Infra.Data.Config.Mappers.MySQLCore
{
    ...
    public class FunctionalityMapMySQLCoreConfig : IEntityTypeConfiguration<Functionality>
    {
        public void Configure(EntityTypeBuilder<Functionality> builder)
        {
            ...
            builder.Property(c => c.ParentId).HasColumnName("functionality_id_parent");
